                ...
                <div key={u._id} style={styles.userRow}>
                  ...
                  <div>
                    ...
                    <p style={styles.userStatus}>
                      <span style={{ width:6, height:6, borderRadius:'50%', background:'#1D9E75', display:'inline-block', marginRight:4 }} />
                      Active
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleAddCollaborator}>
                  ...
                  {addMsg && (
                    <p style={{
                      fontSize:'12px',
                      marginTop:6,
                      color: addMsg.startsWith('✓') ? '#1D9E75' : '#E24B4A'
                    }}>
                      {addMsg}
                    </p>
                  )}
            ...
            {versions.length === 0 ? (
              ...
              versions.map((v, i) => (
                <div
                  ...
                  onClick={() => i > 0 && onRestoreVersion(v)}
                  title={i > 0 ? 'Click to restore' : 'Current version'}
                >
                  <div style={{
                    ...styles.versionDot,
                  ...
                  {i > 0 && (
                    <span style={{ fontSize:'11px', color:'var(--primary)', flexShrink:0, marginTop:2 }}>
                      Restore
                    </span>
                  )}
                </div>
